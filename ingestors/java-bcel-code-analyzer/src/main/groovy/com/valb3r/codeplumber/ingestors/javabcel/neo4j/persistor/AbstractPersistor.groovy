package com.valb3r.codeplumber.ingestors.javabcel.neo4j.persistor
...
abstract class AbstractPersistor<K, V> {
    ...
    static <A, K, V> void persistIfPossible(PersistStage<K, V, A> doPersist, K id, Map<K, V> idToObj,
