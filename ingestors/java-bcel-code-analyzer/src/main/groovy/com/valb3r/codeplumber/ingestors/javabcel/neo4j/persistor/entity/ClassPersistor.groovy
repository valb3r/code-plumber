...
class ClassPersistor extends AbstractPersistor<String, ClassRegistry.ClassDto> {
    ...
    private static class EntityPersistor extends AbstractPersistor.PersistStage<String, ClassRegistry.ClassDto, ClassRegistry.ClassDto> {
    ...
    private static class InterfaceSuperRelPersistor
            extends AbstractPersistor.PersistStage<String, ClassRegistry.ClassDto, ClassRegistry.ClassDto> {
    ...
    private static class FieldsPersistor extends AbstractPersistor.PersistStage<String, ClassRegistry.ClassDto, ClassRegistry.ClassDto> {
    ...
    private static class MethodPersistor extends AbstractPersistor.PersistStage<String, ClassRegistry.ClassDto, ClassRegistry.ClassDto> {
    ...
    private static class OverridesRelPersistor extends AbstractPersistor.PersistStage<String, ClassRegistry.ClassDto, ClassRegistry.ClassDto> {
    ...
    private static class JarRelPersistor extends AbstractPersistor.PersistStage<String, ClassRegistry.ClassDto, ClassRegistry.ClassDto> {
